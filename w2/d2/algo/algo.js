...
function pokemultitype(pokémon){
    for(var i =0; i<pokémon.length; i++){
...
function pokessinglepoison(pokémon){
    for(var i =0; i<pokémon.length; i++){
...
function pokefirstflyiing(pokémon){
    for(var i =0; i<pokémon.length; i++){
...
//pokedivthree(pokémon);

//pokemultitype(pokémon);

//pokessinglepoison(pokémon);

pokefirstflyiing(pokémon);
